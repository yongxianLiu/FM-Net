...
from model.MTUNet.vit import ViT
...
class res_UNet(nn.Module):
    ...
    def forward(self, input):
        ...
        out = torch.cat([rearrange(self.vit2(x3_0), "b (x y) c -> b c x y", x=32, y=32),rearrange(self.vit3(x2_0), "b (x y) c -> b c x y", x=32, y=32),rearrange(self.vit4(x1_0), "b (x y) c -> b c x y", x=32, y=32),rearrange(self.vit5(x0_0), "b (x y) c -> b c x y", x=32, y=32),out], 1)
